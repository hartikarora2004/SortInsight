...
if __name__ == '__main__':
    ms_speed =  10 # interval in millisec by which animation will run.
    li = []
    step_cnt = 0
    try:
    ...
    plt.text(0.015, 0.94, 'input:{}'.format(str(li)), fontsize=10,
             transform=plt.gcf().transFigure)  # to show input data
